    ...
    <main>
      <section class="container text-container" id="boost">
        ...
        <p>
          ...
          vitae eum enim ut aspernatur, ducimus dolore nulla itaque tenetur
          explicabo nostrum consectetur. Beatae odio excepturi doloremque!
          Commodi quo adipisci illo ab nihil repellendus aspernatur! Vero qui
          minus modi facere corrupti similique porro minima rerum eveniet amet
          impedit repellat quo dignissimos fugit officia delectus quam animi
          doloribus ipsam recusandae voluptatem veritatis, illum est? Odit,
          harum tempora? Eligendi aspernatur architecto est nihil, totam saepe
          tenetur corporis voluptas in, sequi consequatur culpa possimus
          doloremque. Veniam possimus dolor odit ab sint est inventore.
        </p>
        <div class="grid">
          <div>
          ...
          <div>
            ...
            <div class="content">
              ...
              <p>
                ...
                veritatis, quasi commodi vitae saepe blanditiis vel delectus
                necessitatibus mollitia, nostrum voluptas impedit. Voluptatum
                labore eos asperiores natus omnis nemo!
              </p>
            </div>
          </div>
          <div>
      ...
      <section id="excited">
        <div class="container">
          <div class="blind content">
            ...
            <a href="#" class="btn"
              >UNSERE <span class="red">REFERENZEN >></span></a
            >
          </div>
        </div>
      </section>
        ...
        <div class="container grid grid-3">
          <div>
            ...
            <p>
              ...
              Obcaecati, quasi. Perferendis adipisci fugiat necessitatibus
              mollitia reiciendis quos nesciunt assumenda aspernatur!
            </p>
          </div>
          <div>
      ...
      <section id="partner" class="container">
        <h2>
          <span class="dot"></span>
          <span class="font2">unsere</span>
          <span class="red">REFERENZEN</span>
          <span class="dot end"></span>
        </h2>
        <div class="grid">
          <div>
      ...
      <section id="testimonial">
        <div class="container">
          <h2>
            <span class="dot"></span>
            <span class="red">KUNDEN</span>
            <span class="font2">stimmen</span>
            <span class="dot end"></span>
          </h2>
          <div class="owl-carousel owl-theme">
            <div class="item">
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam laborum natus hic nulla quae laboriosam quidem assumenda omnis explicabo eos.
              </p>
              <h5>
                <div>
      ...
      <section id="join">
        <div class="container text-container">
          ...
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores accusantium quae pariatur aliquam? Provident, unde voluptates cum beatae culpa ullam libero aut laborum exercitationem facere amet. Distinctio voluptates nemo omnis earum veniam eos quidem alias?
          </p>
          <a href="#" class="btn">30 MINUTEN <span>ERSTGESPRACH >></span> </a>
        </div>
      </section>
    </main>
    <footer>
